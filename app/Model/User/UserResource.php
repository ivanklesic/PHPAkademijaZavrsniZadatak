...
class UserResource implements ResourceInterface
{
    public function insert($data, $admin = false)
    {
        ...
        $statement->bindValue('cpufreq', $data['cpufreq'] !== "" ? $data['cpufreq'] : null);
        $statement->bindValue('cpucores', $data['cpucores'] !== "" ? $data['cpucores'] : null);
        $statement->bindValue('gpuvram', $data['gpuvram'] !== "" ? $data['gpuvram'] : null);
        $statement->bindValue('ram', $data['ram'] !== "" ? $data['ram'] : null);
        $statement->bindValue('storagespace', $data['storagespace'] !== "" ? $data['storagespace'] : null);
