...
class UserResource implements ResourceInterface
{
    public function insert($data, $admin = false)
    {
        ...
        $statement->bindValue('cpufreq', $data['cpufreq'] !== "" ? $data['cpufreq'] : 0);
        $statement->bindValue('cpucores', $data['cpucores'] !== "" ? $data['cpucores'] : 0);
        $statement->bindValue('gpuvram', $data['gpuvram'] !== "" ? $data['gpuvram'] : 0);
        $statement->bindValue('ram', $data['ram'] !== "" ? $data['ram'] : 0);
        $statement->bindValue('storagespace', $data['storagespace'] !== "" ? $data['storagespace'] : 0);
